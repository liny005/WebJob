...
-- 完成提示
-- 插入默认用户
INSERT INTO `job`.`JOB_USER` (`ID`, `USERNAME`, `PASSWORD`, `DISPLAY_NAME`, `EMAIL`, `IS_ENABLED`, `CREATED_AT`, `LAST_LOGIN_AT`, `ROLE`) VALUES (1, 'admin', 'ZlPvG193VMm7dbjdsBI0C7/XI9iUA2rtuCaSLqO+G98=', '系统管理员', NULL, 1, '2026-01-27 15:02:18', '2026-02-28 10:15:19', 'Admin');
